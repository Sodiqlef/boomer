...
href="ukdesign.css">
<link rel="stylesheet"> 
<title> UK BOOMER OFFICIAL</title>
</head>
<body>
<img src="logo2.jpg" alt="logo" class="logo"> <br> <br>
<li class="inline">
   <a href="ukhome.php">HOME</a>|
    <a href="forecast">TODAY FORECAST</a>|
    <a href="index.html">LOGOUT</a>|
</li>

<?php

  echo "<h1>" . $_POST  ["username"] . "UK BOOMER OFFICIAL  </h1>"
...
?>
  ...
  <h2> FREQUENTLY ASKED QUESTIONS 
    ...
    <pre>
    <ol>
      <li> Click on registration at the top navigation menu or click <a href="ukRegistration.html">here</a></li>
      <li> Fill the form</li>
    ...
    <li> All members can check games daily basis from 9.00am</li>
     ...
     <a href="https://wa.me/27680992932?text=Hello!,%20i%20want%20to%20be%20a%20member%20of%20UKBOOMER%20username%20is%20"> GET COUPON CODE HERE </a> <br>
    <br>
    <a href="ukregistration.html"> REGISTER HERE </a>
</body>
